...
import "../utils/PeriodTokenTimelock.sol";
...
contract PeriodTokenTimelockDelegator is
    LinearTokenTimelockDelegator,
    PeriodTokenTimelock
{
    using SafeMath for uint256;

    /// @notice PeriodTokenTimelockDelegator constructor
    ...
    /// @param _period Period of the release window
    constructor(
        address _xms,
        ...
        PeriodTokenTimelock(_beneficiary, _startTime, _duration, _period, _xms)
    {}
